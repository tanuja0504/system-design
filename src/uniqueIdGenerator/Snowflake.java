...
/**
 * java edition of Twitter <b>uniqueIdGenerator.Snowflake</b>, a network service for generating
...
public class Snowflake {
    ...
    /**
     * show settings of uniqueIdGenerator.Snowflake
     */
    @Override
    public String toString() {
        return "uniqueIdGenerator.Snowflake Settings [timestampBits=" + timestampBits + ", datacenterIdBits=" + datacenterIdBits
